                           ...
                           <router-link @click.native="modalToggle" class="starred-board-link" :to="`/board/${board._id}`">
                              ...
                              <div class="modal-toggle-star-btn-container">
                                 <div class="modal-toggle-star-btn">
                                    <a @click="unstarBoard(board._id)" class="header-btn header-star-container" title="Click to star or unstar this board. Starred board show up at the top of your boards list">
