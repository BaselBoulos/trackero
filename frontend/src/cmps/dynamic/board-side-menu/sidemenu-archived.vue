					...
					<div class="list-card-details">
						...
						<div class="badges">
							<span class="js-badges">
								<div v-if="isWatchingBadge(task)" class="badge" title="You are watching this card.">
									<span class="badge-icon icon-sm icon-subscribe"></span>
								</div>
								<div v-if="isDatesBadge(task)" class="badge is-due-soon" title="This card is due in less than twenty-four hours.">
								...
								<div v-if="isChecklist(task)" class="badge" title="Checklist items">
									<span class="badge-icon icon-sm icon-checklist"></span>
									<span class="badge-text">{{ checklistItems(task) }}</span>
								</div>
