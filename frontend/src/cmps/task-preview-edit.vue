<template>
	<div v-if="taskToEdit" class="quick-card-editor" @click.prevent.self="closePreviewEdit()">
		...
		<div class="quick-card-editor-card" :style="{ left: modalPos.left + 'px', top: modalPos.top + 'px' }">
               ...
               /> -->
					...
					<div class="badges">
						<span class="js-badges">
							...
							<div v-if="taskToEdit.description" class="badge is-icon-only" title="This card has a description.">
								<span class="badge-icon icon-sm icon-description"></span>
							</div>
							<div v-if="taskToEdit.comments && taskToEdit.comments.length" class="badge is-icon-only" title="Comments">
								<span class="badge-icon icon-sm icon-comment"></span>
								<span class="badge-text">{{ taskToEdit.comments.length }}</span>
							</div>
							<div v-if="taskToEdit.attachments && taskToEdit.attachments.length" class="badge" title="Attachments">
								<span class="badge-icon icon-sm icon-attachment"></span>
								<span class="badge-text">{{ taskToEdit.attachments.length }}</span>
							</div>
			...
			<button class="nch-button nch-button-primary wide js-save-edits" type="submit" @click="updateTask('save')">Save</button>
			<div class="quick-card-editor-buttons fade-in">
				...
				/>
				<a @click="toggleListCmp($event, 'labels-list')" class="quick-card-editor-buttons-item js-edit-labels">
					<span class="icon-sm icon-label light"></span>
					<span class="quick-card-editor-buttons-item-text"> Edit labels </span>
				</a>

				<a @click="toggleListCmp($event, 'members-list')" class="quick-card-editor-buttons-item js-edit-members">
					<span class="icon-sm icon-member light"></span>
					<span class="quick-card-editor-buttons-item-text"> Change members </span>
				</a>

				<a @click="toggleListCmp($event, 'cover-menu')" class="quick-card-editor-buttons-item js-edit-cover">
					<span class="icon-sm icon-card-cover light"></span>
					<span class="quick-card-editor-buttons-item-text"> Change cover </span>
				</a>
            ...
            <a class="quick-card-editor-buttons-item js-copy-card">
               ...
               <span class="quick-card-editor-buttons-item-text"> Copy</span>
				...
				<a @click="toggleListCmp($event, 'date-picker')" class="quick-card-editor-buttons-item js-edit-due-date">
